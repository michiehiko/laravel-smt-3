...
<nav class="bg-gradient-to-r from-blue-900 via-blue-800 to-blue-900 shadow-lg sticky top-0 z-50">
    <div class="container mx-auto px-4 py-4 flex items-center justify-between">
        <div class="flex items-center gap-3">
            ...
            <span class="font-bold text-xl text-white">Data Kategori</span>
        </div>
...
<main class="flex-grow container mx-auto px-4 py-12">
    ...
    <div class="mb-8">
        <div class="bg-gradient-to-r from-amber-400 via-amber-500 to-amber-400 rounded-t-2xl shadow-xl p-6">
            ...
            <p class="text-blue-800 mt-2 ml-14">Kelola kategori untuk produk & kebutuhan RSHP</p>
        </div>
    </div>
            ...
            <table class="w-full">
                <thead class="bg-gradient-to-r from-blue-900 to-blue-800 text-white">
                    <tr>
                        ...
                        <th class="px-6 py-4 text-left font-bold text-lg">Nama Kategori</th>
                ...
                <tbody class="divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-blue-50 transition-colors duration-200">
                        ...
                        <td class="px-6 py-5 font-medium text-gray-800">{{ $k->nama_kategori }}</td>

                        <td class="px-6 py-5 text-center">
                            <div class="flex items-center justify-center gap-2">

                                {{-- Edit --}}
                                <a href="{{ route('edit_kategori', $k->idkategori) }}" 
                                ...
                                {{-- Delete --}}
                                <form action="{{ route('hapus_kategori', $k->idkategori) }}" method="POST" 
                    ...
                    <tr>
                        <td colspan="4" class="px-6 py-16 text-center">
                            <div class="flex flex-col items-center justify-center">
                                ...
                                <p class="text-xl font-bold text-gray-700 mb-2">Belum ada kategori</p>
                                <p class="text-gray-500">Silakan tambah kategori baru</p>
                            </div>
                        </td>
                    </tr>
                    @endforelse
