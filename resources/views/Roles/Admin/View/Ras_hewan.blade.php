...
<nav class="bg-gradient-to-r from-blue-900 via-blue-800 to-blue-900 shadow-lg sticky top-0 z-50">
    <div class="container mx-auto px-4 py-4 flex items-center justify-between">
        <div class="flex items-center gap-3">
            ...
            <span class="font-bold text-xl text-white">Menu Ras Hewan</span>
        </div>
    ...
    <div class="mb-8">
        <div class="bg-gradient-to-r from-amber-400 via-amber-500 to-amber-400 rounded-t-2xl shadow-xl p-6">
            <h2 class="text-3xl font-bold text-blue-900 flex items-center gap-3">
                ...
                <span>Data Ras Hewan</span>
            </h2>
            <p class="text-blue-800 mt-2 ml-14">Kelola data ras hewan sesuai jenisnya</p>
        </div>
    </div>

    <!-- Tombol Tambah -->
    <div class="mb-6">
        <a href="{{ route('create_ras_hewan') }}" 
            ...
            <table class="w-full">
                <thead class="bg-gradient-to-r from-blue-900 to-blue-800 text-white">
                    <tr>
                        ...
                        <th class="px-6 py-4 text-left font-bold text-lg">Nama Ras</th>
                    ...
                    <tr class="hover:bg-blue-50 transition-colors duration-200">
                        ...
                        <td class="px-6 py-5 text-center">
                            <div class="flex items-center justify-center gap-2">
                                ...
                                {{-- Edit --}}
                                <a href="{{ route('edit_ras_hewan', $r->idras_hewan) }}" 
                                ...
                                {{-- Delete --}}
                                <form action="{{ route('hapus_ras_hewan', $r->idras_hewan) }}" method="POST" 
                                    onsubmit="return confirm('Hapus ras {{ $r->nama_ras }}?')"
                                    class="inline">
                                    @csrf
                                    @method('DELETE')
                                    <button type="submit"
                    ...
                    <tr>
                        <td colspan="4" class="px-6 py-16 text-center">
                            <div class="flex flex-col items-center justify-center">
                                ...
                                <p class="text-xl font-bold text-gray-700 mb-2">Belum ada data ras</p>
                                <p class="text-gray-500">Silahkan tambahkan ras baru</p>
                            </div>
                        </td>
                    </tr>
                    @endforelse
