...
<head>
    ...
    <title>Kode Tindakan Klinis</title>
...
<nav class="bg-gradient-to-r from-blue-900 via-blue-800 to-blue-900 shadow-lg sticky top-0 z-50">
    <div class="container mx-auto px-4 py-4 flex items-center justify-between">
        <div class="flex items-center gap-3">
            ...
            <span class="font-bold text-xl text-white">Kode Tindakan Klinis</span>
        </div>
...
<main class="flex-grow container mx-auto px-4 py-12">
    ...
    <div class="mb-8">
        <div class="bg-gradient-to-r from-amber-400 via-amber-500 to-amber-400 rounded-t-2xl shadow-xl p-6">
            ...
            <p class="text-blue-800 mt-2 ml-14">Kode prosedur klinis untuk layanan medis RSHP</p>
        </div>
    </div>
            ...
            <table class="w-full">
                ...
                <tbody class="divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-blue-50 transition-colors duration-200">
                        ...
                        <td class="px-6 py-5">
                            <span class="inline-flex items-center gap-2 bg-blue-100 text-blue-800 px-3 py-1 rounded-lg font-bold text-sm">
                    ...
                    <tr>
                        <td colspan="7" class="px-6 py-16 text-center">
                            <div class="flex flex-col items-center justify-center">
                                ...
                                <p class="text-xl font-bold text-gray-700 mb-2">Belum ada kode tindakan</p>
                                <p class="text-gray-500">Silakan tambah kode tindakan baru</p>
                            </div>
                        </td>
                    </tr>
                    @endforelse
    ...
    <!-- Kembali -->
    <div class="mt-8">
        <a href="{{ route('roles.admin.data_master') }}" class="inline-flex items-center gap-2 bg-blue-900 hover:bg-blue-800 text-white font-semibold px-6 py-3 rounded-xl shadow-lg transition-all duration-300 transform hover:scale-105">
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
