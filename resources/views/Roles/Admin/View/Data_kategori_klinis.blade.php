    ...
    <div class="container mx-auto px-4 py-4 flex items-center justify-between">
        <div class="flex items-center gap-3">
            <div class="bg-amber-500 rounded-full p-2">
                <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="white" class="bi bi-heart-pulse" viewBox="0 0 16 16">
            ...
            <span class="font-bold text-xl text-white">Menu Kategori Klinis</span>
        </div>
        ...
        <div class="bg-gradient-to-r from-amber-400 via-amber-500 to-amber-400 rounded-t-2xl shadow-xl p-6">
            <h2 class="text-3xl font-bold text-blue-900 flex items-center gap-3">
                <div class="bg-white rounded-full p-3">
                    <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" fill="darkblue" class="bi bi-heart-pulse" viewBox="0 0 16 16">
                        <path d="m8 2.748-.717-.737C5.6.281 2.514.878 1.4 3.053.918 3.995.78 5.323 1.508 7H.43c-2.128-5.697 4.165-8.83 7.394-5.857q.09.083.176.171a3 3 0 0 1 .176-.17c3.23-2.974 9.522.159 7.394 5.856h-1.078c.728-1.677.59-3.005.108-3.947C13.486.878 10.4.28 8.717 2.01zM2.212 10h1.315C4.593 11.183 6.05 12.458 8 13.795c1.949-1.337 3.407-2.612 4.473-3.795h1.315c-1.265 1.566-3.14 3.25-5.788 5-2.648-1.75-4.523-3.434-5.788-5"/>
                        <path d="M10.464 3.314a.5.5 0 0 0-.945.049L7.921 8.956 6.464 5.314a.5.5 0 0 0-.88-.091L3.732 8H.5a.5.5 0 0 0 0 1H4a.5.5 0 0 0 .416-.223l1.473-2.209 1.647 4.118a.5.5 0 0 0 .945-.049l1.598-5.593 1.457 3.642A.5.5 0 0 0 12 9h3.5a.5.5 0 0 0 0-1h-3.162z"/>
                    </svg>
                </div>
            ...
            <p class="text-blue-800 mt-2 ml-14">Kelola kategori klinis untuk tindakan pelayanan medis RSHP</p>
        </div>
    </div>

    <!-- Tombol Tambah -->
    <div class="mb-6">
        <a href="{{ route('create_kategori_klinis') }}" 
            ...
            <table class="w-full">
                <thead class="bg-gradient-to-r from-blue-900 to-blue-800 text-white">
                    <tr>
                        ...
                        <th class="px-6 py-4 text-left font-bold text-lg">Nama Kategori Klinis</th>
                ...
                <tbody class="divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-blue-50 transition-colors duration-200">
                        ...
                        <td class="px-6 py-5 font-medium text-gray-800">{{ $k->nama_kategori_klinis }}</td>

                        <td class="px-6 py-5 text-center">
                            <div class="flex items-center justify-center gap-2">

                                {{-- Edit --}}
                                <a href="{{ route('edit_kategori_klinis', $k->idkategori_klinis) }}" 
                                ...
                                {{-- Hapus --}}
                                <form action="{{ route('hapus_kategori_klinis', $k->idkategori_klinis) }}" method="POST" 
                    ...
                    <tr>
                        <td colspan="4" class="px-6 py-16 text-center">
                            <div class="flex flex-col items-center justify-center">
                                ...
                                <p class="text-xl font-bold text-gray-700 mb-2">Belum ada kategori klinis</p>
                                <p class="text-gray-500">Silakan tambahkan kategori klinis baru</p>
                            </div>
                        </td>
                    </tr>
                    @endforelse
